    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `42b4ad6d51db04aec44b`,
            pinata_secret_api_key: `3ae23f3ac6ee8d71d782dda97f8674e847bdcc64acb1b97523d12fa4764324b8`,
            "Content-Type": "multipart/form-data",
          },
        });
        const ImgHash = `https://turquoise-initial-haddock-152.mypinata.cloud/ipfs/${resFile.data.IpfsHash}`;
        console.log(ImgHash);
